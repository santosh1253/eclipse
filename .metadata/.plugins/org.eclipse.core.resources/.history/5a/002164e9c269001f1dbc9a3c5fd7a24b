...
public class ManyToOneApp {
	...
	/*create table Company (
		...
		Hibernate: 
		 ...
		 Saved records:
		 Company [regno=105, address=Hyderabad, cname=DivyaSree]
Employee [empId=9, empname=Sneha, company=Company [regno=105, address=Hyderabad, cname=DivyaSree]] Employee [empId=8, empname=Raju, company=Company [regno=105, address=Hyderabad, cname=DivyaSree]]
		       */
}
